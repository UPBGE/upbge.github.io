      ...
      <div className={'flex flex-col items-center'}>
        <HSection>
          <div>
            ...
            <p>
              ...
              Blender viewport is what you will see in the game engine.
            </p>
            <p>
              <br />
              Thanks to this integration we have that:
            </p>
            <BulletList>
              <li>
                No need for an import-export pipeline. Simply pressing
                &quot;P&quot; key and you are inside of your game testing your
                changes. This makes the feedback instantaneous, both visually
                and in terms of the game logic development.
              </li>
              <li>
              ...
              <li>
                Best game design pipeline ever because there is no need to adapt
                an external 3d tool package. The game engine specific workspace,
                editors, panels or nodes follow the same convection and
                standards than Blender itself.
              </li>
            </BulletList>
          </div>
        ...
        <HSection>
          <div>
            ...
            <p>
              ...
              player. This scripting language is the language preferred to
              develop the game logic although there are other 3 additional and
            ...
            <BulletList>
              ...
              <li>
                ...
                system developed over the UPBGE node interface to create
              ...
              <li>
                ...
                Components are modules that can be attached to game objects and
                each one serves for a specific purpose. No programming knowledge
        ...
        <HSection>
          <div>
            ...
            <p>
              Almost all the properties of UPBGE can be animated, from basic
              motion/rotation animation, through sprite animation and ending
              with different node properties of both materials and geometry or
              even grease pencil objects.
            </p>

            <p>
              <br />
              Basically to make beautiful animations the developer can use any
        ...
        <Section className={'max-w-7xl'}>
          <div className={'grid grid-cols-1 lg:grid-cols-3 gap-2'}>
            <GridSection>
              ...
              <p>
                UPBGE includes advanced physics simulation in the form of the
                Bullet Physics Engine (Bullet Physics). Most of your work will
                involve setting the right properties on the objects in your
                scene, then you can sit back and let the engine take over. The
                physics simulation can be used for games, but also for
                animation.
              </p>
              <p>
                <br />
                UPBGE physics system can use Rigid, Dynamics or Soft bodies,
                Static Objects and Kinematic Character controller.
              </p>
            </GridSection>
        ...
        <Section className={'max-w-7xl'}>
          <div className={'grid grid-cols-1 lg:grid-cols-3 gap-2'}>
            <GridSection>
              ...
              <p>
                <br />
                It offers simple static navigation mesh which is suitable for
                many simple cases and a navigation mesh construction toolset.
              </p>
            </GridSection>
